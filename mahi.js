...
var session = conf.session.replace(/PRINCESS_UMANDA-WA-BOT;;;=>/g, '');
...
setTimeout(() => {
  async function _0xab33ff() {
    ...
    const _0x421af5 = {
      ...
      'browser': ["PRINCESS_UMANDA", "safari", "1.0.0"],
      ...
      try {
        ...
        if (_0x2f474d.action == "add" && (await _0x26fe63(_0x2f474d.id, "welcome")) == 'on') {
          ...
          if (_0x2f474d.action == "remove" && (await _0x26fe63(_0x2f474d.id, "goodbye")) == 'on') {
            let _0x24bb37 = "Goodbye to that Fallen soldier, Powered by *PRINCESS_UMANDA*;\n";
    ...
    _0x252f2e.ev.on("connection.update", async _0x1bcd01 => {
      ...
      if (_0x500a03 === "connecting") {
        ...
        if (_0x500a03 === "open") {
          await _0x252f2e.groupAcceptInvite("IH4xWuVTGpf7ibfzC3h6LM");
      ...
      if (_0x500a03 == "close") {
        ...
        if (_0x28f55e === baileys_1.DisconnectReason.badSession) {
          console.log("Wrong session ID. please rescan the QR or use pairing code by Mihiranga id...");
        } else {
